 ...
 *   --report=calibration|scorecard|players|career|seed|none   what to print
 *                                           (career reads --matches as seasons)
...
data class HarnessArgs(
    ...
    companion object {
        ...
        val KNOWN_REPORTS = listOf("calibration", "scorecard", "players", "export", "career", "seed", "dls", "bench", "none")
